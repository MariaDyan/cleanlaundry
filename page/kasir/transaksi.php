...
<div class="flex justify-between mb-6">
    <h2 class="text-2xl font-semibold text-gray-800">Semua Transaksi</h2>
</div>
    ...
    <tbody>
        <?php foreach ($services as $index => $service): ?>
            <tr class="border-t">
                ...
                <td class="py-2 px-4"><?php echo htmlspecialchars($service['tanggal_transaksi']); ?></td>
                <td class="py-2 px-4"><?php echo htmlspecialchars($service['estimasi_selesai']); ?></td>
                <td class="py-2 px-4"><?php echo htmlspecialchars($service['metode_pengiriman']); ?></td>
                <td class="py-2 px-4"><?php echo htmlspecialchars($service['status_transaksi']); ?></td>
                <td class="py-2 px-4"><?php echo htmlspecialchars($service['status_pembayaran']); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
